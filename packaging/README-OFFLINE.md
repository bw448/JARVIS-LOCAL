...
3. 打开左侧“连续语音”后，麦克风会在会话中复用；回答边生成边显示，稳定短句会立即开始朗读；
4. 可选择是否在任务完成时主动播报；
